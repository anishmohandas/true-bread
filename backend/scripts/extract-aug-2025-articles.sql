-- Script to insert English articles from True Bread August 2025 issue
...
('august-2025', 'August', 2025, 'August 2025', 'assets/images/covers/aug25_cover.jpg', 'assets/files/TrueBread_Aug_2025.pdf', 'Focusing on health, youth challenges, and biblical studies.', '2025-08-01', 8);
...
(
  'nourishing-the-body-honoring-the-creator',
  'Nourishing the Body, Honoring the Creator',
  'Mrs. Shebha Williams',
  'Clinical Dietitian',
  'M.Sc Clinical Nutrition & Dietetics',
  'Health',
  'assets/images/articles/nourishing-body.jpg',
  'Illustration representing healthy eating and nutrition',
  'As a dietitian and a follower of Christ, I have come to see food not just as fuel for the body, but as a gift from our Creator—meant to be enjoyed, respected, and used wisely.
...
May we seek balance, practice self-care, and glorify God in every bite we take.',
  'A Christian perspective on healthy eating as spiritual stewardship, connecting nutrition with honoring God.',
  '2025-08-01',
  8,
  TRUE,
  'en'
...
Psalms 37: 23-24 The Lord makes firm the steps of the one who delights in him; though he may stumble, he will not fall, for the Lord upholds him with his hand.',
  'Exploring the challenges Christian youth face in a secular world and how they can remain faithful despite feeling like exiles.',
  '2025-08-01',
  10,
  TRUE,
  'en'
...
INSERT INTO articles (id, title, author, job_title, works_at, category, image_url, alt_text, content, excerpt, publish_date, read_time, is_featured, language) VALUES
(
  'blessed-in-the-beatitudes-counter-narrative',
  'Blessed in the Beatitudes: A Counter Narrative',
  'Dr. George Philip',
  NULL,
  NULL,
  'Bible Study',
  'assets/images/articles/beatitudes.jpg',
  'Illustration representing the Beatitudes from Jesus'' Sermon on the Mount',
  'Introduction
...
Blessedness represents a spiritual condition characterized by well-being and prosperity—a profound, joy-infused contentment that remains unshaken by poverty, sorrow, famine, persecution, conflict, or any other challenges or tragedies encountered in life. Those who are blessed may either be victims of oppression or serve as a counter-narrative to the story of oppression. The Beatitudes embody the way God desires his redeemed creation to function within the Kingdom of Heaven. The operation of God''s kingdom is not governed by the violent, powerful, or mighty, but rather by the poor, humble, and similar figures. These eight blessings articulated by Jesus offer crucial insights into a life marked by compassion, humility, and purpose. Consequently, the Beatitudes should not be viewed merely as a compilation of virtues, but rather as a transformative critique of a culture that requires a fundamental shift.',
  'Exploring the deeper meaning of biblical blessedness in the Beatitudes as a counter-narrative to worldly definitions of success and prosperity.',
  '2025-08-01',
  15,
  TRUE,
  'en'
